        ...
        <ul class="list-reset lg:flex justify-end flex-1 items-center">
          <li class="mr-3">
            <!-- <a
              ...
              >Home</a
            > -->
            <NuxtLink to='/' class="inline-block text-black no-underline hover:text-gray-800 hover:text-underline py-2 px-4">
              Home
            </NuxtLink>
          </li>
          <li class="mr-3">
            <!-- <a
              ...
              >Blog</a
            > -->
            <NuxtLink to='/blog' class="inline-block text-black no-underline hover:text-gray-800 hover:text-underline py-2 px-4">
              Blog
            </NuxtLink>
          </li>
          <li class="mr-3">
            <!-- <a
              ...
              >About</a
            > -->
            <NuxtLink to='/about' class="inline-block text-black no-underline hover:text-gray-800 hover:text-underline py-2 px-4">
              About
            </NuxtLink>
          </li>
        </ul>
